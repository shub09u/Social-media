...
console.log(userSlice);
  ...
  return (
    ...
    {/* Sidebar - Fixed */}
    <div className='fixed lg:top-[65px] top-[55px] left-0 w-[89px] h-[calc(110vh-65px)] bg-white'>
      <Sidebarcom  getAllPosts={getAllPosts} />
    </div>
  
    {/* Main Content - Pushed right, scrollable */}
    <div className=' lg:ml-[240px] ml-[10px] flex-1  overflow-y-auto lg:pt-15 pt-13 bg-amber-400' style={{ height: 'calc(110vh - 65px)' }}>
